...
/***/ function(module, exports, __webpack_require__) {
	...
	var _highcharts = __webpack_require__(50);

	var _highcharts2 = _interopRequireDefault(_highcharts);

	var _alert = __webpack_require__(51);

	var _loadAverage = __webpack_require__(52);

	var _loadAverage2 = _interopRequireDefault(_loadAverage);
	...
	__webpack_require__(54)(_highcharts2.default);

	var socket = _socket2.default.connect('http://localhost:3000/');

	socket.on('initialState', function (state) {
	  var loadChart = initializeLoadAvgChart(state);
	  var memoryChart = initializeMemoryChart(state);
	  state.alerts.forEach(_alert.alertUser);
	}).on('alert', _alert.alertUser);

	function loadAvgChartReady(e) {
	  socket.on('monitor', function (_ref) {
	    var timestamp = _ref.timestamp;
	    var loadavg = _ref.loadavg;
	...
	function memoryChartReady(e) {
	  socket.on('monitor', function (_ref2) {
	    var usedmemory = _ref2.usedmemory;
	...
	function initializeLoadAvgChart(state) {
	  var rewriteHistoryObj = function rewriteHistoryObj(_ref3) {
	    var timestamp = _ref3.timestamp;
	    var loadavg = _ref3.loadavg;
	    return [timestamp, loadavg[0]];
	  };
	  _loadAverage2.default.chart.events.load = loadAvgChartReady;
	  _loadAverage2.default.yAxis.max = state.cpus;
	  _loadAverage2.default.series[0].data = state.history.map(rewriteHistoryObj);
	  return new _highcharts2.default.Chart(_loadAverage2.default);
	}

	function initializeMemoryChart(state) {
	  _memory2.default.chart.events.load = memoryChartReady;
	  return new _highcharts2.default.Chart(_memory2.default);
	}

	function stress(e) {
	  _superagent2.default.get('/stress').end();
	  document.getElementById('stress').style.display = 'none';
	}

	function unstress(e) {
	  _superagent2.default.get('/unstress').end();
...
/***/ function(module, exports) {
	...
	var humanizeData = exports.humanizeData = function humanizeData(data) {
	...
	var alertUser = exports.alertUser = function alertUser(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (Highcharts) {
	  __webpack_require__(55)(Highcharts);
	  __webpack_require__(56)(Highcharts);
	  __webpack_require__(57)(Highcharts);
	};
